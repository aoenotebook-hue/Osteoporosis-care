(function (root, factory) {
  ...
  var CONTENT = {
    ...
    onboardingTitle: t('ประเมินโอกาสกระดูกหัก', 'Fracture Risk Assessment'),
    ...
    qWalkAid: t('ท่านใช้อุปกรณ์ช่วยเดินหรือไม่ เช่น ไม้เท้า หรือที่ช่วยพยุงเดิน (วอล์คเกอร์)', 'Do you use a walking aid (cane, walker)?'),
    ...
    boneStatusNormal_desc: t('กระดูกของท่านแข็งแรงดี ทำต่อไปแบบนี้ รับประทานอาหารให้ครบและขยับตัวสม่ำเสมอ', 'Your bones are in good shape. Keep going: eat well and keep moving.'),
    ...
    fallRiskModerate_action: t('ทำท่าฝึกทรงตัวและท่าเพิ่มความแข็งแรงในแอปให้สม่ำเสมอ ตรวจความปลอดภัยในบ้านทุก 6 เดือน เอายาทุกตัวที่รับประทานอยู่ไปให้แพทย์ดู และตรวจตาปีละครั้ง', 'Do the balance and strength exercises in the app regularly. Check your home every 6 months. Show your doctor every medicine you take, and get your eyes tested once a year.'),
    ...
    dueInDays: t('วันจะถึงกำหนด', 'days until it is due'),
    dueOverdueBy: t('วันที่เลยกำหนดมาแล้ว', 'days past due'),
    ...
    secFoodCalcium: t('แคลเซียม รับประทานอะไรได้บ้าง', 'Calcium — what to eat'),
    ...
    foodSunWhy: t('ถ้าขาดวิตามินดี ร่างกายจะดูดซึมแคลเซียมไม่ได้ แม้รับประทานแคลเซียมมากก็ตาม', 'Without vitamin D your body cannot take in calcium, however much you eat'),
    foodTargetLabel: t('เป้าหมายต่อวันของท่าน', 'Your daily target'),
    foodBaselineDiet: t('อาหารที่รับประทานประจำ', 'Your ordinary meals'),
    ...
    fraxGlucocorticoids: t('รับประทานยาสเตียรอยด์เป็นประจำ', 'I take steroid tablets regularly'),
    ...
    nutritionFoodFrequencyIntro: t('ใน 1 สัปดาห์ ท่านรับประทานอาหารต่อไปนี้กี่ครั้ง', 'In a typical week, how many servings of each do you eat?'),
    ...
    nutritionSunQuestion: t('ใน 1 สัปดาห์ ท่านโดนแดดที่แขนหรือขา (ไม่ทาครีมกันแดด) รวมกี่นาที', 'In a week, how many minutes of sun reaches your arms or legs (without sunscreen)?'),
    ...
    nutritionEnough: t('ท่านได้รับจากอาหารเพียงพอแล้ว ไม่ต้องรับประทานอาหารเสริม', 'You are getting enough from food — no extra supplement needed'),
    nutritionConfirmDoctor: t('ตัวเลขนี้เป็นเพียงการประมาณ ควรให้แพทย์ยืนยันปริมาณที่เหมาะกับท่านอีกครั้ง', 'These figures are an estimate — please confirm the right dose with your doctor'),
    ...
    drugTitle: t('ยารักษากระดูกพรุนของท่าน', 'My Osteoporosis Medication'),
    ...
    drugDentalBody: t('บอกทันตแพทย์ทุกครั้งว่าท่านใช้ยานี้ ถ้ามีฟันที่ต้องรักษา ควรทำให้เรียบร้อยก่อนเริ่มยา และอย่าถอนฟันหรือผ่าตัดในช่องปากโดยไม่ปรึกษาแพทย์ที่สั่งยาก่อน เพราะอาจทำให้กระดูกขากรรไกรตายได้ แม้จะพบไม่บ่อย', 'Always tell your dentist you take this medicine. Have any dental problems treated before you start, and never have a tooth out or oral surgery without checking with the doctor who prescribed it — jawbone problems are uncommon, but they do happen.'),
    nutritionEggsPerDay: t('ไข่ {n} ฟองต่อวัน', '{n} eggs a day'),
    chartViewAsTable: t('ดูเป็นตาราง', 'View as table'),
    chartDateHeader: t('วันที่', 'Date'),
    printBlocked: t('เนื้อหาในแอปนี้ไม่อนุญาตให้พิมพ์', 'This content is not available for printing'),
    drugAdherenceLog: t('ประวัติการได้รับยา', 'Dose history'),
    drugAdherenceEmpty: t('ยังไม่มีประวัติ', 'No doses recorded yet'),
    drugSupplementNote: t('แคลเซียมและวิตามินดีเป็นอาหารเสริม ไม่ใช่ยารักษากระดูกพรุน ดูปริมาณที่ท่านควรได้ที่หน้าอาหาร', 'Calcium and vitamin D are supplements, not treatment for thin bones. The Food tab shows how much you need.'),
    ...
    moveNeverDoBody: t('หลีกเลี่ยงท่านอนหงายลุกขึ้นนั่ง (ซิทอัพ) ท่าก้มแตะปลายเท้าโดยขาตรง การบิดตัวแรง ๆ และการยกของหนักโดยก้มหลัง เพราะเพิ่มแรงกดที่กระดูกสันหลัง', 'Avoid sit-ups, straight-leg toe touches, forceful twisting and lifting heavy things with a bent back — these load the spine.'),
    ...
    safetyIntro: t('แตะรายการที่บ้านของท่านทำได้แล้ว รายการที่ยังไม่ได้ทำจะขึ้นสีไว้ให้เห็นชัด', 'Tap what your home already has. Anything still missing stays highlighted for you to fix.'),
    ...
    fallRiskMedsBody: t('ยานอนหลับ ยาคลายกังวล ยาลดความดันบางตัว ยาแก้แพ้ และเหล้า ทำให้ง่วงหรือหน้ามืดได้ ปีละครั้งให้เอายาทุกตัวที่รับประทานอยู่ไปให้แพทย์ดู', 'Sleeping pills, medicine for worry, some blood pressure pills, allergy medicine and alcohol can all make you sleepy or dizzy. Once a year, show your doctor every medicine you take.'),
    ...
    monthlyCheckinTitle: t('บันทึกอาการประจำเดือน', 'Monthly Check-in'),
    ...
    checkinDone: t('บันทึกเรียบร้อยแล้ว', 'Check-in complete'),
    checkinDoneBody: t('เก็บบันทึกของเดือนนี้ไว้แล้ว แล้วพบกันเดือนหน้า', 'This month is recorded. See you next month.'),
    ...
    reconsentTitle: t('ขอให้ท่านยืนยันความยินยอมอีกครั้ง', 'Please confirm your consent again'),
    reconsentBody: t('แอปเพิ่มการป้องกันข้อมูลของท่าน ก่อนส่งข้อมูลให้โรงพยาบาลต่อ กรุณาอ่านและยืนยันความยินยอมด้านล่างอีกครั้ง ข้อมูลที่บันทึกไว้ในเครื่องยังอยู่ครบ', 'The app now protects your records better. Before it sends them to the hospital again, please read and confirm the consent below. Everything saved on this phone is still here.'),
    ...
    registerAgeRange: t('แอปนี้สำหรับผู้ที่มีอายุ 18 ปีขึ้นไป กรุณาตรวจสอบปีเกิดอีกครั้ง', 'This app is for people aged 18 and over. Please check the year of birth.'),
    ...
    offlineNotice: t('ขณะนี้ไม่มีอินเทอร์เน็ต แอปจะส่งข้อมูลให้เองเมื่อกลับมาออนไลน์', 'You are offline — your data will be sent automatically when you reconnect')
  };
  ...
  var LISTS = {
    learnScreening: [
      ...
      t('คนที่รับประทานยาสเตียรอยด์ติดต่อกันตั้งแต่ 3 เดือนขึ้นไป', 'Anyone taking steroid tablets for 3 months or more'),
  ...
  var MED_CLASSES = [
    ...
    },
    {
      ...
      sideEffects: t('หลังได้รับยาครั้งแรก อาจมีไข้ ปวดเมื่อยตัวคล้ายเป็นไข้หวัด 1-3 วัน ให้ดื่มน้ำมาก ๆ และรับประทานยาพาราเซตามอลได้ อาการมักไม่เกิดซ้ำในปีถัดไป', 'After the first infusion you may feel feverish and achy like a mild flu for 1-3 days. Drink plenty of water and paracetamol is fine. This usually does not happen again in later years.'),
  ...
  var CALCIUM_FOODS = [
    ...
    { id: 'sardine', name: t('ปลากระป๋องซาร์ดีน (รับประทานทั้งก้าง)', 'Canned sardines (with bones)'), serving: t('ครึ่งกระป๋อง', 'Half a can'), mgPerServing: 240 },
  ...
  /** The notice a patient agrees to at registration; see CONSENT_VERSIONS. */
  var PDPA_NOTICE_VERSION = CONSENT_VERSIONS[CONSENT_VERSIONS.length - 1];

  /**
   * What the app sends to register. consent is the evidence the patient
   * ticked: which notice (consentVersion), in which language and when. The
   * device key is what later records are checked against.
   */
  function buildRegistrationPayload(fields, token, deviceKey) {
    fields = fields || {};
    var birthYear = normalizeBirthYear(fields.yearOfBirth);
    var consent = fields.consent && typeof fields.consent === 'object' ? fields.consent : null;
    return {
      ...
      sex: fields.sex || null,
      consent: !!consent,
      consentVersion: consent ? consent.version : null,
      consentAt: consent ? consent.at : null,
      consentLang: consent ? consent.lang : null,
  ...
  /** The record as the Apps Script will judge it; todayYmd defaults to the phone's date. */
  function validateRecord(payload, todayYmd) {
    var errors = checkRecord(payload, todayYmd || formatYMD(new Date()));
    return { valid: errors.length === 0, errors: errors };
  }

  /** 32 random bytes as base64url, the phone's registration key. */
  function encodeDeviceKey(bytes) {
    ...
    if (bits > 0) out += alphabet.charAt((value << (6 - bits)) & 63);
    return out;
  }
  ...
  return {
    ...
    encodeDeviceKey: encodeDeviceKey,
