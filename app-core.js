(function (root, factory) {
  ...
  var CONTENT = {
    ...
    nutritionFoodFrequencyIntro: t('ใน 1 สัปดาห์ ท่านกินอาหารต่อไปนี้กี่ครั้ง', 'In a typical week, how many servings of each do you eat?'),
    ...
    nutritionEnough: t('ท่านได้รับจากอาหารเพียงพอแล้ว ไม่ต้องกินอาหารเสริม', 'You are getting enough from food — no extra supplement needed'),
  ...
  var MED_CLASSES = [
    {
      ...
      icon: '💊', cadenceLabel: t('สัปดาห์ละครั้ง', 'Once a week'), route: t('ยาเม็ด กินเองที่บ้าน', 'Tablet, taken at home'),
      ...
      instructions: t('กินตอนเช้าขณะท้องว่างทันทีหลังตื่นนอน พร้อมน้ำเปล่า 1 แก้วเต็ม (ห้ามใช้ชา กาแฟ นม หรือน้ำผลไม้) หลังกินยาให้นั่งหรือยืนตัวตรงอย่างน้อย 30 นาที ห้ามนอนราบ และรออย่างน้อย 30 นาทีก่อนกินอาหาร ยาอื่น หรือแคลเซียม', 'Take it first thing in the morning on an empty stomach with a full glass of plain water — not tea, coffee, milk or juice. Stay sitting or standing upright for at least 30 minutes, do not lie down, and wait at least 30 minutes before food, other medicines or calcium.'),
      missedDose: t('หากลืม ให้กินในเช้าวันถัดไปเพียง 1 เม็ด แล้วกลับไปกินวันเดิมของสัปดาห์ถัดไป ห้ามกิน 2 เม็ดในวันเดียวกัน', 'If you forget, take one tablet the next morning, then go back to your usual day the following week. Never take two tablets on the same day.'),
      sideEffects: t('อาจแสบร้อนกลางอก กลืนลำบาก หรือปวดท้องได้ มักดีขึ้นเมื่อกินยาถูกวิธีและไม่นอนราบหลังกินยา หากแสบมากหรือกลืนเจ็บ ให้แจ้งแพทย์', 'It can cause heartburn, difficulty swallowing or stomach discomfort. This usually improves if you take it correctly and stay upright. Tell your doctor if it burns badly or hurts to swallow.'),
    ...
    },
    {
      ...
      sideEffects: t('หลังได้รับยาครั้งแรก อาจมีไข้ ปวดเมื่อยตัวคล้ายเป็นไข้หวัด 1-3 วัน ให้ดื่มน้ำมาก ๆ และกินยาพาราเซตามอลได้ อาการมักไม่เกิดซ้ำในปีถัดไป', 'After the first infusion you may feel feverish and achy like a mild flu for 1-3 days. Drink plenty of water and paracetamol is fine. This usually does not happen again in later years.'),
  ...
  var CALCIUM_FOODS = [
    ...
    { id: 'sardine', name: t('ปลากระป๋องซาร์ดีน (กินได้ทั้งก้าง)', 'Canned sardines (with bones)'), serving: t('ครึ่งกระป๋อง', 'Half a can'), mgPerServing: 240 },
